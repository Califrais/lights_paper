...
\institute[shortinst]{
  ...
  \vspace{.6cm}
  \textcolor{blue_pres}{\Large Les 53èmes Journées de Statistique de la Société Française de Statistique}\\
  \vspace{.5cm}
  \large
  \textbf{Van Tuan NGUYEN}\\
  \vspace{.25cm}
  \scriptsize
  \href{mailto:simon.bussy@gmail.com}{\texttt{vantuan.nguyen@califrais.fr}}\\
  \vspace{.4cm}
  \small
...
% \begin{itemize}
%   \item<1-> JLCMs~\citep{vermunt2003latent} : homogeneous latent subclasses sharing the same marker trajectories and the same prognostic
...
% \centering
% \includegraphics[width=9cm]{figures/graphical_model}
...
\uncover<2->{\includegraphics[width=.48\textwidth]{./figures/survivaL_curve}}
\uncover<3->{\includegraphics[width=.45\textwidth]{./figures/estimated_survivaL_curve}}
