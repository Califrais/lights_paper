...
\end{equation}
For the update of $\xi_k^{(w)}$, we choose the L-BFGS-B algorithm to solve the following convex minimization problem
\begin{equation}
...
\noindent The closed-form update of $\lambda_0^{(w)}$ is given by
\begin{equation}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=.9\textwidth]{./figures/obj_vcg}
\includegraphics[width=.45\textwidth]{./figures/xi_estimation}
\includegraphics[width=.4\textwidth]{./figures/baseline_estimation}
\includegraphics[width=.9\textwidth]{./figures/beta_estimation}
\includegraphics[width=.9\textwidth]{./figures/gamma_estimation}
\end{figure}
