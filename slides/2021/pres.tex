...
\title[JSM 2020 \\ Lights \\ \insertframenumber/\inserttotalframenumber \vspace{-1cm}]{}
...
\institute[shortinst]{
  ...
  \vspace{.6cm}
  \textcolor{blue_pres}{\Large 2020 Joint Statistical Meetings}\\
  \vspace{.5cm}
  \large
  \textbf{Simon Bussy}\\
  \vspace{.25cm}
...
\begin{itemize}
  ...
  \end{split} 
  \end{equation*}
  \item Similar tricks for $\gamma_k^{(w+1)}$
