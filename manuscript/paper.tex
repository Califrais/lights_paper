...
\begin{equation}
  \label{eq:def-asso-features}
  \lambda(t|\cM_k(t), G = k) = \lambda_0(t) \exp \big\{\gamma_k^\top \Psi_k(t) \big\},
\end{equation}
where $\Psi_k(t) \in \R^{L\sA}$ denotes the association features vector at time $t$.

\paragraph{Specification of the functionals $(\varphi_{k,a})_{a\in \cA}$.}
