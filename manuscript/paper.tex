...
\tikzstyle{box}=[rectangle, draw=black!100]
  ...
  \node[rectangle, inner sep=8mm,draw=black!130, ultra thick, fit= (beta) (xi) (gamma),label={[anchor=west, yshift=-0.4cm, xshift=-8cm]{\Large$\bm{k = 1, \ldots,K}$}}] at (6.5,0.4) {};
  ...
  \node[rectangle,inner sep=6mm, draw=black!100,  label=center:{\color{white}\Large{\textbf{Time-independent}}}, minimum width=5cm, minimum height = 1cm, fill = black!50] at (5,2.8) {};

  \node[rectangle,inner sep=6mm, draw=black!100,  label=center:{\color{white}\Large{\textbf{Time-to-event}}}, minimum width=5cm, minimum height = 1cm, fill = black!50] at (11.5,2.8) {};
